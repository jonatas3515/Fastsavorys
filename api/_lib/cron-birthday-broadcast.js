/**
 * FastSavory's - Sub-módulo: Broadcast de Mensagens de Aniversário
 */

const { createClient } = require('@supabase/supabase-js');
const { updateCustomFields, sendFlowToUser } = require('./manychat');
...
async function handleBirthdayBroadcast(req, res) {
...
module.exports = { handleBirthdayBroadcast };
